...
<tr>
	<td align="center">
		<button type="button" onclick="open_preview('auxinput')"><?=$lang->addmsg->print?></button>
...
if(array_key_exists('prev', $pages)) {
	echo "<a href=\"javascript:void(0)\" style=\"text-decoration:none\" onclick=\"load_search('auxinput', '{$pages['prev']}')\">&nbsp;<img src='/img/menu/button_grey_list_prev.png'>&nbsp;</a>";
	echo '&nbsp;';
}
...
foreach($pages as $key => $val) {
	...
	else				echo "<a href=\"javascript:void(0)\" onclick=\"load_search('auxinput', '{$val}')\">{$val}</a>";

	echo '&nbsp;';
}

if(array_key_exists('next', $pages)) {
	echo "<a href=\"javascript:void(0)\" style=\"text-decoration:none\" onclick=\"load_search('auxinput', '{$pages['next']}')\">&nbsp;<img src='/img/menu/button_grey_list_next.png'>&nbsp;</a>";
	echo '&nbsp;';
}
