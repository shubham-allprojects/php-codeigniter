...
<script type="text/javascript" src="<?PHP echo base_url(); ?>assets/js/plugin/jquery.simplemodal/jquery.simplemodal-1.4.4.min.js?v=1234" charset="utf-8"></script>
...
<script type="text/javascript" src="<?PHP echo base_url(); ?>assets/js/common.js?v=1234" charset="utf-8"></script>

<script src="<?PHP echo base_url(); ?>assets/js/ajax/private.js"></script>